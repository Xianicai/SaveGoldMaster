...
abstract class CommonRecyclerAdapter<T>(
    ...
    constructor(context: Context, datas: List<T>, layoutId: Int) : this(context, datas, layoutId, null)
    constructor(context: Context, datas: List<T>, multiTypeSupport: MultiTypeSupport<T>) :
