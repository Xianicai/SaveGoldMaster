package com.example.zhanglibin.savegoldmaster.account
...
import com.example.zhanglibin.savegoldmaster.home.presenter.LoginPresenterImpl
...
class LoginActivity : BaseMVPActivity<LoginPresenterImpl>(), LoginContract.LoginView, View.OnClickListener {
    ...
    override fun accountLoginSuccess() {
    }
